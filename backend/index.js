...
const privateKey = fs.readFileSync(
  `/etc/letsencrypt/live/www.hotelmidorchardkasol.in/privkey.pem`,
  "utf8"
);
const certificate = fs.readFileSync(
  `/etc/letsencrypt/live/www.hotelmidorchardkasol.in/cert.pem`,
  "utf8"
);
const ca = fs.readFileSync(
  `/etc/letsencrypt/live/www.hotelmidorchardkasol.in/chain.pem`,
  "utf8"
);

...
const BlogPostPage = () => {
  ...
  const {title,date,excerpt,imageUrl} = location.state.state
  ...
  return (
    <div className="bg-slate-800 bg-opacity-10 min-h-screen">
      <div className="container mx-auto px-4 py-16">
        <Link to="/" className="text-[#3DBBCD] hover:text-teal-600 transition-colors duration-300 mb-8 inline-block">
          &larr; Back to Blog
        </Link>
